...
Попробуем проверить эту конфигурацию (10 секунд спамим по кнопке), работает - алерт сначал стал `pending`, а затем `firing` и пришел в Alertmanager.
...
Теперь займемся отправкой уведомлений.
